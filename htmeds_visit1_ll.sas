/* Recreating code from Rikki Tanner, PhD at UAB - for Visit 1*/

*libname meds 'L:\REGARDS\JHS\Jan2016VC\data\data\Visit 3\1-data';
libname meds 'C:\Users\litkowse\Desktop\Vanguard_2016\Vanguard_2016\data\Visit1\1-data';
...
proc print data=save.beta_cardio_nonselect; where subjid="J245504"; run; *timolol drops-- see field msra4c;
proc print data=save.beta_cardio_nonselect; where subjid="J519559"; run; *drops-- see field msra11c;
proc print data=save.beta_cardio_nonselect; where subjid="J552593"; run; *drops-- see field msra11c;

/*confirm oral timolol*/
proc print data=save.beta_cardio_nonselect; where subjid="J227498"; run; *not oral-- see field msra7c;
...
libname save 'C:\Users\litkowse\Desktop\Vanguard_2016\Vanguard_2016\data\Visit1';
...
%do %while (&var ne );
	...
	data save.&var;
	merge &var._id (in=a keep=subjid &var.) msra(in=b);
	by subjid;
	if a*b;
	run;
...
proc freq data=save.htmeds_v1; tables ace; run;
